...
{    
    ...
    Colors
    {
        ...
        "ya_Damage"                "236 199 35 255"     //Damage numbers
        "ya_Crosshair"             "255 255 255 255"     //Crosshair color
        "ya_CrosshairDamage"       "152 13 24 255"       //Crosshair damage flash color
                                                      //Make this the same as "Crosshair" to disable the flash
                                                      //Crosshairs can be activated in /scripts/hudlayout.res                                             
                            
        //// HUD COLORS
                            
        "ya_Ammo"                  "7 251 252 255"      //Current clip
		"ya_AmmoReserve"           "31 22 188 255"      //Reserve clip
        "ya_AmmoLow"               "255 0 206 255"      //Low ammo warning
        
        "ya_Health"				"9 255 4 255"    
        "ya_Positive"			"93 225 103 255"    //Buffed HP font color   
        "ya_Negative"			"255 0 9 255"    //Low HP
		"RedHP"					"255 180 180 255"	//Low HP Flash to Color
		...
		"ya_Shadow"             "0 0 0 100"			//Shadows under numbers
